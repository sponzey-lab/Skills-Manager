...
| --- | --- | --- |
| `file-system-analysis-store.js` | Persist analysis metadata. | Reads and writes repository metadata. |
...
| `file-system-skill-repository.js` | Manage source skill directories. | Reads and mutates repository files. |
